        ...
        execute: function () {
            ...
            let NegociacaoService = class NegociacaoService {
                ...
                obtemNegociacoesDaSemana() {
                    ...
                    return this._http.get(`${SERVICE_URL}/negociacoes/semana`).then(dados => dados.map(objeto => new Negociacao(new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
                ...
                obtemNegociacoesDaSemanaAnterior() {
                    ...
                    return this._http.get(`${SERVICE_URL}/negociacoes/anterior`).then(dados => dados.map(objeto => new Negociacao(new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
                ...
                obtemNegociacoesDaSemanaRetrasada() {
                    ...
                    return this._http.get(`${SERVICE_URL}/negociacoes/retrasada`).then(dados => dados.map(objeto => new Negociacao(new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
